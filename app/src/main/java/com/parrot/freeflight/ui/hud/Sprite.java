...
public abstract class Sprite 
{
	...
	public void surfaceChanged(GL10 gl, int width, int height)
	{
		...
		Log.d(TAG, "Layout height: "+surfaceHeight+" width: "+surfaceWidth);
		layout(width, height);
	}
	...
	protected void layout(int width, int height) 
	{
		switch (alignment) {
			...
			case BOTTOM_RIGHT:
				...
				break;
			case CENTER:
				bounds.set((width-getWidth())/2,(height-getHeight())/2,(width-getWidth())/2+getWidth(),(height-getHeight())/2+getWidth());
				break;
			default:
	...
	public abstract void setViewAndProjectionMatrices(float [] vMatrix, float[] projMatrix, float[] rotMatrix);
    public abstract int getWidth();
    public abstract int getHeight();
    public abstract void freeResources();
	public abstract void setScaleParam(float scaleCentreX, float scaleCentreY, float scaleFactor);
	public abstract void setRotateParam(Point rotCentre, float rotAngle);
}
