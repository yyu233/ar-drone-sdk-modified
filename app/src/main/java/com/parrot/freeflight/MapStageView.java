...
public class MapStageView extends SurfaceView
        implements
        SurfaceHolder.Callback
{
    ...
    public MapStageView(Context context) {
        super(context);
    ...
    public void setRenderer(MapStageRenderer renderer)
    {
    ...
    class DrawThread extends Thread {
        ...
        private MapStageView view;
        private boolean run = false;

        public DrawThread(SurfaceHolder surfaceHolder, MapStageView gameView) {
